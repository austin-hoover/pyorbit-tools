...
def main(cfg : DictConfig) -> None:
    ...
    inj_coords_ti[0] = inj_x  - cfg.paint.xi
    inj_coords_ti[1] = inj_xp - cfg.paint.xpi
    inj_coords_ti[2] = inj_y  - cfg.paint.yi
    inj_coords_ti[3] = inj_yp - cfg.paint.ypi
    
    # Final coordinates of closed orbit at injection point  [x, x', y, y']
    inj_coords_tf = np.zeros(4)
    inj_coords_tf[0] = inj_x  - cfg.paint.xf
    inj_coords_tf[1] = inj_xp - cfg.paint.xpf
    inj_coords_tf[2] = inj_y  - cfg.paint.yf
    inj_coords_tf[3] = inj_yp - cfg.paint.ypf
